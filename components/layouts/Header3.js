...
const Header3 = ({headerSetting = {}}) => {      
    ...
    return (
        <>     
        <MobileMenu/>
         <header className="uni-header uk-position-top uni-header-3">
                                ...
                                <div className="uk-navbar-right uk-flex-1 uk-flex-right">
                                    <div className="uk-navbar-item uk-visible@m">
                                        <ul className="uk-subnav uk-subnav-small">
                                            ...
                                            <li>
                                                <a href="https://instagram.com/unistudioco"><i className="uk-icon uk-icon-medium unicon-logo-instagram"></i></a>
                                            </li>
                                            <li>
                                                <a href="https://facebook.com/unistudioco"><i className="uk-icon uk-icon-medium unicon-logo-facebook"></i></a>
                                            </li>
                                        </ul>
                                    </div>
