        ...
        <div className="my_switcher">            
            <div className="wrap uk-overflow-hidden">
                ...
                <label className="switch">
                    ...
                    <img className="uk-visible dark:uk-hidden" width="120" src="/images/moon.svg" alt="Nerko" loading="lazy" /> 
                    <img className="uk-hidden dark:uk-visible" width="120" src="/images/light.svg" alt="Nerko" loading="lazy" /> 
                </label>
            </div>
        </div>
        </div>
