                ...
                <div className="uk-container">
                    <header className="uk-grid-xsmall uk-flex-center uk-flex-middle uk-text-center uk-child-width-auto@m uk-grid" data-uk-grid>
                        <div className="uk-panel">
                            <h2 className="uk-h3 uk-h1@m uk-font-display uk-text-uppercase">Nerko's <span className="uk-text-gradient">Roadmap</span></h2>
                        </div>
                    </header>
                            ...
                            <div>
                                <div className="uni-phase uk-panel uk-overflow-hidden uk-card uk-card-small uk-card-medium@m uk-card-border uk-box-shadow-xsmall uk-radius-medium uk-radius-large@m dark:uk-background-white-5">
                                    ...
                                    <div className="uk-panel">
                                        ...
                                        <h3 className="uni-phase-title uk-h4 uk-h3@m uk-font-display uk-text-uppercase uk-margin-remove-bottom">Production</h3>
                            ...
                            <div>
                                <div className="uni-phase uk-panel uk-overflow-hidden uk-card uk-card-small uk-card-medium@m uk-card-border uk-box-shadow-xsmall uk-radius-medium uk-radius-large@m dark:uk-background-white-5">
                                    ...
                                    <div className="uk-panel">
                                        ...
                                        <h3 className="uni-phase-title uk-h4 uk-h3@m uk-font-display uk-text-uppercase uk-margin-remove-bottom">Minting</h3>
                            ...
                            <div>
                                <div className="uni-phase uk-panel uk-overflow-hidden uk-card uk-card-small uk-card-medium@m uk-card-border uk-box-shadow-xsmall uk-radius-medium uk-radius-large@m dark:uk-background-white-5">
                                    ...
                                    <div className="uk-panel">
                                        ...
                                        <h3 className="uni-phase-title uk-h4 uk-h3@m uk-font-display uk-text-uppercase uk-margin-remove-bottom">New Nfts</h3>
                            ...
                            <div>
                                <div className="uni-phase uk-panel uk-overflow-hidden uk-card uk-card-small uk-card-medium@m uk-card-border uk-box-shadow-xsmall uk-radius-medium uk-radius-large@m dark:uk-background-white-5">
                                    ...
                                    <div className="uk-panel">
                                        ...
                                        <h3 className="uni-phase-title uk-h4 uk-h3@m uk-font-display uk-text-uppercase uk-margin-remove-bottom">Metaverse</h3>
