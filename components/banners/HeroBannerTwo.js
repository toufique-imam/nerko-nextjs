                    ...
                    <div className="uk-section uk-flex-center uk-flex-middle" data-uk-height-viewport="">
                        <div className="uk-card uk-flex-center uk-text-center">
                            <div className="uk-panel uk-width-2xlarge@m uk-position-z-index">
                                ...
                                <h2 className="uk-h2 uk-heading-d1@m">Buy & Sell Nerko's Collection</h2>
                                <p className="uk-text-lead">Invest and manage all your NFTs at one place.</p>
                                <a href="#uni_collection" className="uk-button uk-button-medium uk-button-large@m uk-button-gradient uk-margin-medium-top">Browse collection</a>
                            </div>
                        </div>
                    </div>
                </div>
